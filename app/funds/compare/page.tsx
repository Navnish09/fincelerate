...
export default function FundComparison() {
  ...
  return (
    <div className="min-h-screen bg-[#060A20F2] text-white">
      <div
        className={cn(
      ...
      <div className="max-w-7xl mx-auto py-10 px-5 space-y-5">
        ...
        <div className="text-center space-y-4">
          <div className="flex">
            <Link
              href={"/funds"}
              className="text-secondary2 font-bold cursor-pointer border border-secondary2 p-1 rounded-full hover:bg-secondary2/10 transition-colors"
            >
              <ArrowLeft size={20} />
            </Link>
          </div>
